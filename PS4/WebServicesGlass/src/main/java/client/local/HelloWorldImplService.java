 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://paint.ms/", wsdlLocation = "http://localhost:8080/WebServicesWildfly/HelloWorldImpl?wsdl")
public class HelloWorldImplService
    extends Service
{

    private static final URL HELLOWORLDIMPLSERVICE_WSDL_LOCATION;
    private static final WebServiceException HELLOWORLDIMPLSERVICE_EXCEPTION;
    private static final QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://paint.ms/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServicesWildfly/HelloWorldImpl?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://paint.ms/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://paint.ms/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
